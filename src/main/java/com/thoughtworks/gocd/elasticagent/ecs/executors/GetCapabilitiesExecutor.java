...
import com.thoughtworks.gocd.elasticagent.ecs.domain.Capabilities;
...
public class GetCapabilitiesExecutor {
    public GoPluginApiResponse execute() {
        return new DefaultGoPluginApiResponse(SUCCESS_RESPONSE_CODE, new Capabilities(false, true, true).toJSON());
    }
}
